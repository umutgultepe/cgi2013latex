...
Section~\ref{sec:3} describes the proposed methodology, including the details of depth map filtering, body measurements, and temporal averaging. Section~\ref{sec:4} provides experimental results. Section~\ref{sec:5} gives conclusions and further research directions. 
...
\section{Cloth Simulation Framework}
\label{sec:5}
