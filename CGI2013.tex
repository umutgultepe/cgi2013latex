...
\institute{Department of Computer Engineering, Bilkent University \at Ankara, Turkey \and 
Department of Computer Engineering, Bilkent University \at Ankara, Turkey}
...
\begin{figure}
	...
	\end{center}
	\caption{Human joints provided by KFW SDK~\cite{CodeProject2011}.}
...
\begin{figure*} 
	...
	\centerline{(c)}
	\caption{Examples of different dresses on a model with different postures: (a) sun dress, (b) jeans and vest and (c) flight suit.}
	\label{fig:examples}
\end{figure*}
...
\bibitem{Kim2013}
Kim, D.-E., and LaBat, K.: Consumer experience in using 3D virtual garment simulation technology. Journal of The Textile Institute, In press (2013)
