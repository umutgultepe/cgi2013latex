...
Section~\ref{sec:Physics} explaines the cloth simulation framework and uses of the spheres and measurements. 
Section~\ref{sec:Motion} illustrates the techniques used for coping with the inferior motion data problems.
Section~\ref{sec:Measurements} describes the proposed methodology, including the details of depth map filtering, body measurements, and temporal averaging. Section~\ref{sec:Experiments} provides experimental results. Section~\ref{sec:Conclusions} gives conclusions and further research directions. 
